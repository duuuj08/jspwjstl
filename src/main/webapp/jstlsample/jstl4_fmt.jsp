...
<fmt:formatDate value="${now }" type="both" dateStyle="medium" pattern="YY-MM-dd [a] hh:mm:ss"/>
...
<fmt:formatDate value="${now }" type="both" dateStyle="full" pattern="YY-MM-dd [a] hh:mm:ss"/>
<hr />
